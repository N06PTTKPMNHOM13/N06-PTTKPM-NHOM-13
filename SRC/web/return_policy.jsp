...
<html>
    <head>
        ...
        <title>Mua ban xe cu: Return Policy</title>
    ...
    <body>
        ...
        <div class="container mt-3">
            <h3>Return Policy</h3>
            <p>Thank you for shopping at Mua ban xe cu. We strive to ensure that our customers are completely satisfied with their purchases. If you are not entirely happy with your purchase, we're here to help.</p>
            ...
            <ul>
                ...
                <li>Proof of purchase or receipt is required to process your return.</li>
            </ul>

            <p><strong>Non-Returnable Items:</strong></p>
            <ul>
                <li>Opened Cars, unless they are defective or damaged.</li>
                <li>Gift cards.</li>
                <li>Downloadable digital music.</li>
            </ul>

            <h4>Refunds</h4>
            <p><strong>Processing Refunds:</strong></p>
            <ul>
                <li>Once we receive your item, we will inspect it and notify you that we have received your returned item.</li>
                <li>We will immediately notify you of the status of your refund after inspecting the item.</li>
            ...
            <h4>Exchanges</h4>
            <p>We only replace items if they are defective or damaged. If you need to exchange it for the same item, send us an email at <a href="" style="color: #50222b">Muabanxecu@gmail.com</a> and send your item to: Mua ban xe cu.</p>
            ...
            <p>If you received a damaged or incorrect item, please contact us immediately at <a href="" style="color: #50222b">Muabanxecu@gmail.com</a> for assistance.</p>
